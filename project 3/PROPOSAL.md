...
**Core features:** 
- Use Mapbox Geocoding API and MBTA V3API to convert a place name into coordinates and find the nearest transit stops to near the coordinates
- Create a webpage that displays the nearest stops and a map
- Allows users to input their the name of the location or address
